    ...
    public partial class frmprofesor : System.Web.UI.Page
    {
        ...
        protected void Buscar()
        {
            try
            {
                ...
                this.gridview.DataSource = Logic.GetByPersona(this.txtbuscar.Text);
                this.gridview.DataBind();
            }
            catch (Exception ex)
            {
        ...
        protected void CargarPersona()
        {
            try
            {
                ...
                if (registar)
                {
                    ...
                    {
                        Object fecha = datetimepicker4.Value;
                        //DateTime fech = Convert.ToDateTime(fecha);
                        //string converFecha = string.Format("{0:dd/MM/yyyy}", fech);  
                        ...
                        pers.Fecha_Nac = Convert.ToDateTime(fecha);
                        pers.Legajo = Convert.ToInt32(this.TxtLegajo.Text);
                        pers.Tipo_Persona = "Profesor";
        ...
        protected void gridview_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            this.datetimepicker4.Value = (Convert.ToString(this.gridview.SelectedRow.Cells[6].Text)).ToString();
