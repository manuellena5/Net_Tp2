...
namespace Data.Database
{
    public class UsuarioAdapter:Adapter
    {
        ...
        public Usuario TraerUno(int ID)
        {
            ...
            {
                this.OpenConnection();
                SqlCommand cmdUsuarios = new SqlCommand("select usr.id_usuario,per.id_persona,usr.nombre_usuario,usr.clave,per.nombre,per.apellido,per.email,per.tipo_persona from usuarios usr inner join personas per on usr.id_persona=per.id_persona where usr.id_usuario=@ID", SqlConn);
        ...
        protected void Update(Usuario usuario)
        {
            ...
            {
                this.OpenConnection();
                SqlCommand cmdSave = new SqlCommand("update usuarios set nombre_usuario=@nombre_usuario,clave=@clave,id_persona=@id_persona where id_usuario=@id_usuario", SqlConn);
