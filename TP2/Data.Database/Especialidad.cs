   ...
   public class Especialidad:Adapter
    {
       ...
       public _Especialidades TraerUno(int id)
       {
           ...
           {
               this.OpenConnection();
               SqlCommand cmdEspe = new SqlCommand("select esp.id_especialidad,esp.desc_especialidad from especialidades esp where esp.id_especialidad=@id", SqlConn);
               cmdEspe.Parameters.Add("@id", SqlDbType.Int).Value = id;
               SqlDataReader drEspe = cmdEspe.ExecuteReader();
               if (drEspe.Read())
               {
                   espe.Idespecialidad = (int)drEspe["id_especialidad"];
                   espe.DescEspecialidad = (string)drEspe["desc_especialidad"];
           ...
           {
               Exception ExcepcionManejada = new Exception("Error al buscar la especialidad", ex);
           }
           finally
           {
               this.CloseConnection();
