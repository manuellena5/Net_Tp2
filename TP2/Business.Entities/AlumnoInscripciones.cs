...
namespace Business.Entities
{
    public class AlumnoInscripciones:BusinessEntity
    {
        ...
        public AlumnoInscripciones(int id_inscripcion, int id_alumnos, int id_curso, string condicion, int nota, string plan, string materia, int anio,int cupo,int legajo,string nombre,string apellido,string comision,string tipo)
        {
